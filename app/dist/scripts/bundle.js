...
global.jQuery=require("jquery"),bootstrap=require("bootstrap"),mustache=require("mustache"),jQuery(document).ready(function(){alert("Hello")});var name=" Lorenzo A";document.write("Hello, "+name+"!");
for(var max=5,i=0;i<max;i++)console.log(i);
